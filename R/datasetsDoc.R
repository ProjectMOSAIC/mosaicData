...
#'   \describe{
#'     \item{\code{maptools}}{region name http://mappinghacks.com/ data sets}
...
#'     \item{\code{A12B}}{Hollingshead categories (1=Major profess, 2=Lesser professional, 3=Minor professional, 4=Clerical/sales, 5=Skilled manual, 6=Semi-skilled, 7=Unskilled, 8= Homemaker, 9=No occupation)}
#'     \item{\code{A13}}{Usual employment pattern in last 6 months (1=Full time, 2=Part time, 3=Student, 4=Unemployed, 5=Control envir)}
#'     \item{\code{A14A}}{Lived alone-last 6 months (0=No, 1=Yes)}
#'     \item{\code{A14B}}{Lived with a partner-last 6 months (0=No, 1=Yes}
#'     \item{\code{A14C}}{Lived with parent(s)-last 6 months (0=No, 1=Yes)}
#'     \item{\code{A14D}}{Lived with children-last 6 months (0=No, 1=Yes)}
#'     \item{\code{A14E}}{Lived with other family-last 6 months (0=No, 1=Yes}
#'     \item{\code{A14F}}{Lived with friend(s)-last 6 months (0=No, 1=Yes)}
...
#'     \item{\code{A14G}}{Lived w/ other-last 6 months (0=No, 1=Yes)}
#'     \item{\code{A15A}}{#nights in overnight shelter-last 6 months}
#'     \item{\code{A15B}}{# nights on street-last 6 months}
#'     \item{\code{A15C}}{# months in jail-last 6 months}
#'     \item{\code{A16A}}{# months in overnight shelter-last 5 years}
#'     \item{\code{A16B}}{# moths on street-last 5 years}
#'     \item{\code{A16C}}{# months in jail-last 5 years}
#'     \item{\code{A17A}}{Received SSI -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17B}}{Received SSDI -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17C}}{Received AFDC -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17D}}{Received EAEDC -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17E}}{Received WIC -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17F}}{Received unemployment benefits -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17G}}{Received Workman's Compensation -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A17H}}{Received Child Support -- past 6 months (0=No, 1=Yes)}
...
#'     \item{\code{A17I}}{Received other income -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{A18_REC1}}{Most money made in 1 year (recode)  (0=$19,000 or less, 1=$20,000-$49,000, 2=$50,000 or more)}
#'     \item{\code{A18_REC2}}{Most money made-continuous recode}
#'     \item{\code{A18}}{Most money made in any 1 year-last 5 years (1=<5000, 2=5000-10000, 3=11000-19000, 4=20000-29000, 5=30000-39000, 6=40000-49000, 7=50000+}
...
#'     \item{\code{ALONE6M}}{Usually lived alone past 6 months (0=No, 1=Yes)}
#'     \item{\code{ALT_TRT}}{Alternative tratments (0=No, 1=Yes)}
#'     \item{\code{ANYSUBSTATUS}}{Used alcohol, heroin, or cocaine since leaving detox-6 months}
#'     \item{\code{ANY_INS}}{Did you have health insurance in past 6 months (0=No, 1=Yes)}
#'     \item{\code{ANY_UTIL}}{Any recent health utilization (0=No, 1=Yes)}
...
#'     \item{\code{B10}}{Any physcal/emotional problem interfere with social activities-last 4 weeks (1=All of the time, 2=Most of the time, 3=Some of the time, 4= A lttle of time, 5= None of the time)}
#'     \item{\code{B11A}}{I seem to get sick easier than other people (1=Definitely true, 2=Mostly True, 3=Don't know, 4=Mostly false, 5=Definitely false)}
...
#'     \item{\code{B2}}{Compared to 1 year ago, how is your health now (1=Much better, 2=Somewhat better, 3=About the same, 4=Somewhat worse, 5=Much worse)}
...
#'     \item{\code{B3D}}{Does health limit you in climb several stair flights (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B3E}}{Does health limit you in climb 1 stair flight (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B3F}}{Does health limit you in bend/kneel/stoop (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B3G}}{Does health limit you in walking >1 mile (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B3H}}{Does health limit you in walking sevral blocks (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B3I}}{Does health limit you in walking 1 block (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B3J}}{Does health limit you in bathing/dressing self (1=Limited a lot, 2=Limited a little, 3=Not limited)}
#'     \item{\code{B4A}}{Cut down work/activity due to physical health-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B4B}}{Accomplish less due to phys health-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B4C}}{Lim wrk/act type due to phys health-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B4D}}{Diff perf work due to phys health-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B5A}}{Cut wrk/act time due to emot prbs-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B5B}}{Accomplish ess due to emot probs-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B5C}}{<carefl w/wrk/act due to em prb-last 4 weeks (0=No, 1=Yes)}
#'     \item{\code{B6}}{Ext phys/em intf w/norm soc act-last 4 weeks (1=Not al all, 2=Slightly, 3=Moderately, 4=Quite a bit, 5=Extremely)}
#'     \item{\code{B7}}{Amount of bodily pain -- past 4 weeks (1=None, 2=Very mild, 3= Mild, 4=Moderate, 5= Severe, 6= Very severe)}
#'     \item{\code{B8}}{Amount of pain interfering with normal work-last 4 weeks (1=Not at all, 2=A little bit, 3=Moderately, 4=Quite a bit, 5=Extremely}
#'     \item{\code{B9A}}{Did you feel full of pep -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9B}}{Have you been nervous -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9C}}{Felt nothing could cheer you-last 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9D}}{Have you felt calm/peaceful -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9E}}{Did you have a lot of energy -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9F}}{Did you feel downhearted -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9G}}{Did you feel worn out -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9H}}{Have you been a happy pers -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
#'     \item{\code{B9I}}{Did you feel tired -- past 4 weeks (1=All of the time, 2=Most of the time, 3 = Good bit of the time, 4=Some of the time, 5=A little of time, 6=None of the time)}
...
#'     \item{\code{C1B}}{Told by MD had asthma, emphysema, chr lung dis (0=No, 1=Yes)}
...
#'     \item{\code{C2A2}}{Have you had skin infections -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2B1}}{Have you ever had pneumonia (0=No, 1=Yes)}
#'     \item{\code{C2B2}}{Have you had pneumonia -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2C1}}{Have you ever had septic arthritis (0=No, 1=Yes)}
#'     \item{\code{C2C2}}{Have you had septic arthritis -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2D1}}{Have you ever had TB (0=No, 1=Yes)}
#'     \item{\code{C2D2}}{Have you had TB-last 6 months (0=No, 1=Yes)}
#'     \item{\code{C2E1}}{Have you ever had endocarditis (0=No, 1=Yes)}
#'     \item{\code{C2E2}}{Have you had endocarditis -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2F1}}{Have you ever had an ulcer (0=No, 1=Yes)}
#'     \item{\code{C2F2}}{Have you had an ulcer -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2G1}}{Have you ever had pancreatitis  (0=No, 1=Yes)}
#'     \item{\code{C2G2}}{Have you had pancreatitis -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2H1}}{Ever had abdom pain req overnt hosp stay (0=No, 1=Yes)}
#'     \item{\code{C2H2}}{Abdom pain req ovrnt hosp stay-last 6 months (0=No, 1=Yes)}
#'     \item{\code{C2I1}}{Have you ever vomited blood (0=No, 1=Yes)}
#'     \item{\code{C2I2}}{Have you vomited blood -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2J1}}{Have you ever had hepatitis (0=No, 1=Yes)}
#'     \item{\code{C2J2}}{Have you had hepatitis -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2K1}}{Ever had blood clots in legs/lungs (0=No, 1=Yes)}
#'     \item{\code{C2K2}}{Blood clots in legs/lungs -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2L1}}{Have you ever had osteomyelitis (0=No, 1=Yes)}
#'     \item{\code{C2L2}}{Have you had osteomyelitis -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2M1}}{Chest pain using cocaine req ER/hosp (0=No, 1=Yes)}
#'     \item{\code{C2M2}}{Chest pain using coc req ER/hosp-last 6 months (0=No, 1=Yes)}
#'     \item{\code{C2N1}}{Have you ever had jaundice (0=No, 1=Yes)}
#'     \item{\code{C2N2}}{Have you had jaundice -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2O1}}{Lower back pain > 3 months req med attn (0=No, 1=Yes)}
#'     \item{\code{C2O2}}{Lwr back pain >3 months req med attention-last 6 months (0=No, 1=Yes)}
#'     \item{\code{C2P1}}{Ever had seizures or convulsions (0=No, 1=Yes)}
#'     \item{\code{C2P2}}{Had seizures or convulsions -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2Q1}}{Ever had drug/alcohol overdose requiring ER attention (0=No, 1=Yes)}
#'     \item{\code{C2Q2}}{Drug/alcohol overdose req ER attn (0=No, 1=Yes)}
#'     \item{\code{C2R1}}{Have you ever had a gunshot wound (0=No, 1=Yes)}
#'     \item{\code{C2R2}}{Had a gunshot wound -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2S1}}{Have you ever had a stab wound (0=No, 1=Yes)}
#'     \item{\code{C2S2}}{Have you had a stab wound -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2T1}}{Ever had accident/falls req med attn (0=No, 1=Yes)}
#'     \item{\code{C2T2}}{Had accident/falls req med attn -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2U1}}{Ever had fract/disloc to bones/joints (0=No, 1=Yes)}
#'     \item{\code{C2U2}}{Fract/disloc to bones/joints -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2V1}}{Ever had injury from traffic accident (0=No, 1=Yes)}
#'     \item{\code{C2V2}}{Had injury from traffic accident -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C2W1}}{Have you ever had a head injury (0=No, 1=Yes)}
#'     \item{\code{C2W2}}{Have you had a head injury -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{C3A1}}{Have you ever had syphilis (0=No, 1=Yes)}
#'     \item{\code{C3A2}}{# times had syphilis}
#'     \item{\code{C3A3}}{Have you had syphilis in last 6 months (0=No, 1=Yes)}
#'     \item{\code{C3B1}}{Have you ever had gonorrhea (0=No, 1=Yes)}
#'     \item{\code{C3B2}}{# times had gonorrhea}
#'     \item{\code{C3B3}}{Have you had gonorrhea in last 6 months (0=No, 1=Yes)}
#'     \item{\code{C3C1}}{Have you ever had chlamydia (0=No, 1=Yes)}
#'     \item{\code{C3C2}}{# of times had Chlamydia}
#'     \item{\code{C3C3}}{Have you had chlamydia in last 6 months (0=No, 1=Yes)}
...
#'     \item{\code{C3F3}}{Had other STD's (not HIV)-last 6 months (0=No, 1=Yes)}
...
#'     \item{\code{C3G3}}{Have you been tested for HIV/AIDS-last 6 months (0=No, 1=Yes)}
#'     \item{\code{C3G4}}{What was the result of last test (1=Positive, 2=Negative, 3=Refused, 4=Never got result, 5=Inconclusive}
#'     \item{\code{C3H1}}{Have you ever had PID (0=No, 1=Yes)}
#'     \item{\code{C3H2}}{# of times had PID}
#'     \item{\code{C3H3}}{Have you had PID in last 6 months (0=No, 1=Yes)}
#'     \item{\code{C3I}}{Have you ever had a Pap smear (0=No, 1=Yes)}
#'     \item{\code{C3J}}{Have you had a Pap smear in last 3 years (0=No, 1=Yes)}
#'     \item{\code{C3K_M}}{How many months pregnant}
...
#'     \item{\code{CHR_SUM}}{Sum chronic medical conds/HIV ever}
...
#'     \item{\code{D2}}{Take prescription medicdation regularly for physical problem (0=No, 1=Yes)}
...
#'     \item{\code{E10A}}{have you been to med clinic-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E10B1_R}}{Mental health treatment past 6m y/n (0=No, 1=Yes)}
#'     \item{\code{E10B1}}{# x visit ment health clin/prof-last 6 months}
#'     \item{\code{E10B2_R}}{Med clinic/private MD past 6m y/n (0=No, 1=Yes)}
#'     \item{\code{E10B2}}{# x visited med clin/priv MD-last 6 months}
#'     \item{\code{E10C19}}{Visited private MD-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E11A}}{Did you stay ovrnite/+ in hosp-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E11B}}{# times ovrnight/+ in hosp-last 6 months }
#'     \item{\code{E11C}}{Total # nights in hosp-last 6 months}
#'     \item{\code{E12A}}{Visited Hosp ER for med care -- past 6 months (0=No, 1=Yes)}
#'     \item{\code{E12B}}{# times visited hosp ER-last 6 months}
#'     \item{\code{E13}}{Tlt # visits to MDs-last 2 weeks bef detox}
#'     \item{\code{E14A}}{Recd trtmt from acupuncturist-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E14B}}{Recd trtmt from chiropractor-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E14C}}{Trtd by hol/herb/hom med prac-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E14D}}{Recd trtmt from spirit healer-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E14E}}{Have you had biofeedback-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E14F}}{Have you underwent hypnosis-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E14G}}{Received other treatment-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E15A}}{Tried to get subst ab services-last 6 months (0=No, 1=Yes)}
...
#'     \item{\code{E16A7}}{Afraid othrs find out about my health prob (0=No, 1=Yes)}
#'     \item{\code{E16A8}}{My substance abuse interferes (0=No, 1=Yes)}
#'     \item{\code{E16A9}}{I don't have someone to watch my children (0=No, 1=Yes)}
...
#'     \item{\code{E2A}}{Detox prog for alcohol or drug prob-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E2B}}{# times entered a detox prog-last 6 months}
#'     \item{\code{E2C}}{# nights ovrnight in detox prg-last 6 months}
#'     \item{\code{E3A}}{Holding unit for drug/alcohol prob-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E3B}}{# times in holding unity=last 6 months}
#'     \item{\code{E3C}}{# total nights in holding unit-last 6 months}
#'     \item{\code{E4A}}{In halfway hse/resid facil-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E4B}}{# times in hlfwy hse/res facil-last 6 months}
#'     \item{\code{E4C}}{Ttl nites in hlfwy hse/res fac-last 6 months}
#'     \item{\code{E5A}}{In day trtmt prg for alcohol/drug-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E5B}}{Total # days in day trtmt prg-last 6 months}
#'     \item{\code{E6}}{In methadone maintenance prg-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E7A}}{Visit outpt prg subst ab couns-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E7B}}{# visits outpt prg subst ab couns-last 6 months}
#'     \item{\code{E8A1}}{Saw MD/H care worker regarding alcohol/drugs-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E8A2}}{Saw Prst/Min/Rabbi re alcohol/drugs-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E8A3}}{Employ Asst Prg for alcohol/drug prb-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E8A4}}{Oth source cnsl for alcohol/drug prb-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E9A}}{AA/NA/slf-hlp for drug/alcohol/emot-last 6 months (0=No, 1=Yes)}
#'     \item{\code{E9B}}{How often attend AA/NA/slf-hlp-last 6 months (1=Daily, 2=2-3 Times/week, 3=Weekly, 4=Every 2 weeks, 5=Once/month}
...
#'     \item{\code{F1A}}{Bothered by thngs not generally bothered by (0=Rarely/never, 1=Some of the time, 2=Occas/moderately, 3=Most of the time)}
#'     \item{\code{F1B}}{My appetite was poor (0=Rarely/never, 1=Some of the time, 2=Occas/moderately, 3=Most of the time)}
...
#'     \item{\code{F1G}}{I felt everything I did was an effort (0=Rarely/never, 1=Some of the time, 2=Occas/moderately, 3=Most of the time)}
...
#'     \item{\code{F1P}}{I enjoyed life (0=Rarely/never, 1=Some of the time, 2=Occas/moderately, 3=Most of the time)}
...
#'     \item{\code{G1A_30}}{Diff contr viol beh-sig per last 30 days (0=No, 1=Yes)}
#'     \item{\code{G1A}}{Diff contr viol beh for sig time per evr (0=No, 1=Yes)}
#'     \item{\code{G1B_30}}{Had thoughts of suicide-last 30 days (0=No, 1=Yes)}
#'     \item{\code{G1B_REC}}{Suicidal thoughts past 30 days y/n (0=No, 1=Yes)}
#'     \item{\code{G1B}}{Ever had thoughts of suicide (0=No, 1=Yes)}
#'     \item{\code{G1C_30}}{Attempted suicide-last 30 days (0=No, 1=Yes)}
#'     \item{\code{G1C}}{Attempted suicide ever (0=No, 1=Yes)}
#'     \item{\code{G1D_30}}{Prescr med for psy/emot prob-last 30 days (0=No, 1=Yes)}
#'     \item{\code{G1D_REC}}{Prescribed psych meds past 30 days y/n (0=No, 1=Yes)}
#'     \item{\code{G1D}}{Prescr med for pst/emot prob ever (0=No, 1=Yes)}
#'     \item{\code{GH}}{SF-36 general health perceptions (0-100)}
#'     \item{\code{GOV_SUPP}}{Received government support past 6 m (0=No, 1=Yes)}
#'     \item{\code{GROUP}}{Randomization Group (0=Control, 1=Clinic)}
#'     \item{\code{H10_30}}{# days in last 30 bef detox used cannabis}
#'     \item{\code{H10_LT}}{# years regularly used cannabis}
...
#'     \item{\code{H11_30}}{# days in last 30 bef detox used halluc}
#'     \item{\code{H11_LT}}{# years regularly used hallucinogens}
...
#'     \item{\code{H12_30}}{# days in last 30 bef detox used inhalant}
#'     \item{\code{H12_LT}}{# years regularly used inhalants}
...
#'     \item{\code{H13_30}}{# days used >1 sub/day-last 30 bef detox}
#'     \item{\code{H13_LT}}{# years regularly used >1 subst/day}
#'     \item{\code{H13_RT}}{Route of admin of >1 subst/day (0=N/A. 1=Oral, 2=Nasal, 3=Smoking, 4=Non-IV injection, 5=IV)}
#'     \item{\code{H14}}{According to interviewer, which substance is main problem (0=No problem, 1=Alcohol, 2=Alcohol to intox, 3=Heroin 4=Methadone, 5=Other opiate/analg, 6=Barbituates, 7=Sed/hyp/tranq, 8=Cocaine, 9=Amphetamines, 10=Marij/cannabis, 15=Alcohol and one or more drug, 16=More than one drug}
#'     \item{\code{H15A}}{# times had alcohol DTs}
#'     \item{\code{H15B}}{# times overdosed on drugs}
#'     \item{\code{H16A}}{$ spent on alcohol-last 30 days bef detox}
#'     \item{\code{H16B}}{$ spent on drugs-last 30 days bef detox}
#'     \item{\code{H17A}}{# days had alcohol prob-last 30 days bef det}
#'     \item{\code{H17B}}{# days had drug prob-last 30 days bef det}
#'     \item{\code{H18A}}{How troubled by alcohol probs-last 30 days (0=Not at all, 1=Slightly, 2=Moderately, 3=Considerably, 4=Extremely)}
#'     \item{\code{H18B}}{How troubled by drug probs-last 30 days (0=Not at all, 1=Slightly, 2=Moderately, 3=Considerably, 4=Extremely)}
#'     \item{\code{H19A}}{How import is treatment for alcohol problems now (0=Not at all, 1=Slightly, 2=Moderately, 3=Considerably, 4=Extremely)}
#'     \item{\code{H19B}}{How important is trtmnt for drug probs now (0=Not at all, 1=Slightly, 2=Moderately, 3=Considerably, 4=Extremely)}
#'     \item{\code{H1_30}}{# days in past 30 bef detox used alcohol}
#'     \item{\code{H1_LT}}{# years regularly used alcohol}
#'     \item{\code{H1_RT}}{Route of administration use alcohol (0=N/A. 1=Oral, 2=Nasal, 3=Smoking, 4=Non-IV injection, 5=IV)}
#'     \item{\code{H2_30}}{#days in 3- bef detox use alcohol to intox}
#'     \item{\code{H2_LT}}{# years regularly used alcohol to intox}
#'     \item{\code{H2_PRB}}{Problem sub: alcohol to intox (0=No, 1=Yes)}
...
#'     \item{\code{H3_LT}}{# years regularly used heroin}
...
#'     \item{\code{H4_30}}{# days used methadone-last 30 bef detox}
#'     \item{\code{H4_LT}}{# years regularly used methadone}
...
#'     \item{\code{H5_30}}{# days used opiates/analg-last 30 bef detox}
#'     \item{\code{H5_LT}}{# years regularly used oth opiates/analg}
#'     \item{\code{H5_PRB}}{Problem sub: other opiates/analg (0=No, 1=Yes)}
#'     \item{\code{H5_RT}}{Route of admin of other opiates/analg (0=N/A. 1=Oral, 2=Nasal, 3=Smoking, 4=Non-IV injection, 5=IV)}
#'     \item{\code{H6_30}}{# days in past 30 before detox used barbiturates}
#'     \item{\code{H6_LT}}{# years regularly used barbiturates}
#'     \item{\code{H6_PRB}}{Problem sub: barbiturates (0=No, 1=Yes)}
#'     \item{\code{H6_RT}}{Route of admin of barbiturates (0=N/A. 1=Oral, 2=Nasal, 3=Smoking, 4=Non-IV injection, 5=IV)}
#'     \item{\code{H7_30}}{# days used sed/hyp/trnq-last 30 bef det}
#'     \item{\code{H7_LT}}{# years regularly used sed/hyp/trnq}
...
#'     \item{\code{H8_30}}{# days in last 30 bef detox used cocaine}
#'     \item{\code{H8_LT}}{# years regularly used cocaine}
...
#'     \item{\code{H9_30}}{# days in last 30 bef detox used amphet}
#'     \item{\code{H9_LT}}{# years regularly used amphetamines}
...
#'     \item{\code{I1}}{Avg # drinks in last 30 days bef detox}
#'     \item{\code{I2}}{Most drank any 1 day in last 30 bef detox}
#'     \item{\code{I3}}{On days used heroin, avg # bags used}
#'     \item{\code{I4}}{Most bags heroin used any 1 day -- 30 before det}
#'     \item{\code{I5}}{Avg $ amt of heroin used per day}
...
#'     \item{\code{IMPUL2}}{Inventory of Drug Use Consequences InDUC-2L-Impulse control-Raw (w/0 M23)}
#'     \item{\code{IMPUL}}{Inventory of Drug Use Consequences InDUL-2L-Impulse control-Raw}
...
#'     \item{\code{J10A}}{Get physically sick when stop using heroin (0=No, 1=Yes)}
...
#'     \item{\code{J5A}}{Get physically sick when stop using cocaine (0=No, 1=Yes)}
...
#'     \item{\code{K1}}{Do you currently smoke cigarettes (1=Yes-every day, 2=Yes-some days, 3=No-former smoker, 4=No-never>100 cigarettes}
#'     \item{\code{K2}}{Avg # cigarettes smoked per day}
#'     \item{\code{K3}}{Considering quitting cigarettes within next 6 months (0=No, 1=Yes)}
...
#'     \item{\code{L13}}{Passed out due to drinking-last 12 months (0=No, 1=Once, 2=More than once)}
...
#'     \item{\code{L16}}{After drinkng heavily was thinkng unclear (0=No, 1=Yes, few hrs, 2=Yes,1-2 days, 3=Yes, many days)}
#'     \item{\code{L17}}{D/t drinkng felt heart beat rapidly (0=No, 1=Once, 2=Several times)}
#'     \item{\code{L18}}{Do you constntly think about drinkng/alcohol (0=No, 1=Yes)}
...
#'     \item{\code{L2}}{Often have hangovers Sun or Mon mornings (0=No, 1=Yes)}
#'     \item{\code{L3}}{Have you had the shakes when sobering (0=No, 1=Sometimes, 2=Alm evry time drink)}
#'     \item{\code{L4}}{Do you get physically sick as reslt of drinking (0=No, 1=Sometimes, 2=Alm evry time drink)}
...
#'     \item{\code{M16}}{Felt guilt/ashamed because of my alcohol drug use (0=No, 1=Yes)}
...
#'     \item{\code{M23}}{Gotten in physical fights when use alcohol/drugs (0=No, 1=Yes)}
#'     \item{\code{M24}}{My physical health was harmed by alcohol/drug use (0=No, 1=Yes)}
...
#'     \item{\code{M29}}{My physical appearance harmed by alcohol/drug use (0=No, 1=Yes)}
#'     \item{\code{M2}}{Felt bad about self because of alcohol/drug use (0=No, 1=Yes)}
#'     \item{\code{M30}}{My family hurt because of my alcohol drug use (0=No, 1=Yes)}
...
#'     \item{\code{M41}}{Arrested for DUI of alcohol or oth drugs (0=No, 1=Yes)}
...
#'     \item{\code{M48}}{Physically hurt/injured/burned when using alcohol/drugs (0=No, 1=Yes)}
...
#'     \item{\code{O1A}}{# people spend tx w/who drink alcohol (1=None, 2= A few, 3=About half, 4= Most, 5=All)}
...
#'     \item{\code{P1A}}{Physical abuse/assault by family members/person I know (0=No, 1=Yes, 7=Not sure)}
#'     \item{\code{P1B}}{Age first physically assaulted by person I know}
#'     \item{\code{P1C}}{Physically assaulted by person I know-last 6 months (0=No, 1=Yes)}
#'     \item{\code{P2A}}{Physical abuse/assault by stranger (0=No, 1=Yes, 7=Not sure)}
#'     \item{\code{P2B}}{Age first physically assaulted by stranger}
#'     \item{\code{P2C}}{Physically assaulted by stranger-last 6 months (0=No, 1=Yes)}
#'     \item{\code{P3}}{Using drugs/alcohol when physically assaulted (1=Don't know, 2=Never, 3=Some cases, 4=Most cases, 5=All cases, 9=Never assaulted)}
#'     \item{\code{P4}}{Person who physically assaulted you was using alcohol/drugs (1=Don't know, 2=Never, 3=Some cases, 4=Most cases, 5=All cases, 9=Never assaulted)}
#'     \item{\code{P5A}}{Sexual abuse/assault by family member/person you know (0=No, 1= Yes, 7=Not sure)}
#'     \item{\code{P5B}}{Age first sexually assaulted by person you know}
#'     \item{\code{P5C}}{Sexually assaulted by person you know-last 6 months (0=No, 1=Yes)}
#'     \item{\code{P6A}}{Sexual abuse/assault by stranger (0=No, 1=Yes, 7=Not sure)}
#'     \item{\code{P6B}}{Age first sexually assaulted by stranger}
#'     \item{\code{P6C}}{Sexually assaulted by stranger-last 6 months (0=No, 1=Yes)}
#'     \item{\code{P7}}{Using drugs/alcohol when sexually assaulted (1=Don't know, 2=Never, 3=Some cases, 4=Most cases, 5=All cases, 9=Never assaulted)}
#'     \item{\code{P8}}{Person who sexually assaulted you using alcohol/drugs (1=Don't know, 2=Never, 3=Some cases, 4=Most cases, 5=All cases, 9=Never assaulted)}
...
#'     \item{\code{PRIM_SUB}}{First drug of choice (0=None, 1=Alcohol, 2=Cocaine, 3=Heroin, 4=Barbituates, 5=Benzos, 6=Marijuana, 7=Methadone, 8=Opiates)}
...
#'     \item{\code{Q13}}{# times had sex In past 6 months (0=Never, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q14}}{How often had sex to get drugs-last 6 months (0=Never, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q15}}{How often given drugs to have sex-last 6 months (0=Never, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q16}}{How often were you paid for sex-last 6 months (0=Never, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q17}}{How often you pay pers for sex-last 6 months (0=Never, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q18}}{How often use condoms during sex=last 6 months (0=No sex/always, 1=Most of the time, 2=Some of the time, 3=None of the time)}
...
#'     \item{\code{Q1B}}{Have you injected drugs-last 6 months (0=No, 1=Yes)}
#'     \item{\code{Q20}}{Safer sex is always your responsibility (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
#'     \item{\code{Q2}}{Have you shared needles/works-last 6 months (0=No/Not shot up, 3=Yes)}
#'     \item{\code{Q3}}{# people shared needles w/past 6 months (0=No/Not shot up, 1=1 other person, 2=2-3 diff people, 3=4/+ diff people)}
#'     \item{\code{Q4}}{How often been to shoot gall/hse-last 6 months (0=Never, 1=Few times or less, 2= Few times/month, 3= Once or more/week)}
#'     \item{\code{Q5}}{How often been to crack house-last 6 months (0=Never, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q6}}{How often shared rinse-water-last 6 months (0=Nevr/Not shot up, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q7}}{How often shared a cooker-last 6 months (0=Nevr/Not shot up, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q8}}{How often shared a cotton-last 6 months (0=Nevr/Not shot up, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{Q9}}{How often use syringe to div drugs-last 6 months (0=Nevr/Not shot up, 1=Few times or less, 2=Few times/month, 3=Once or more/week)}
#'     \item{\code{R1A}}{I really want to change my alcohol/drug use (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
#'     \item{\code{R1B}}{Sometimes I wonder if I'm an alcohol/addict (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
#'     \item{\code{R1C}}{Id I don't change alcohol/drug probs will worsen (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
...
#'     \item{\code{R1H}}{Already doing thngs to change alcohol/drug use (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
...
#'     \item{\code{R1K}}{I wonder if I'm in control of alcohol/drug use (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
#'     \item{\code{R1L}}{My alcohol/drug use is causing a lot of harm (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
#'     \item{\code{R1M}}{Actively cutting down/stopping alcohol/drug use (1=Strongly disagree, 2=Disagree, 3= Agree, 4=Strongly agree)}
...
#'     \item{\code{RAW_RE}}{SOCRATES-Recognition-Raw}
...
#'     \item{\code{S1C}}{At interview patientt obviously anxious/nervous (0=No, 1=Yes)}
#'     \item{\code{S1D}}{Trouble with real tst/thght dis/par at interview (0=No, 1=Yes)}
...
#'     \item{\code{T1C}}{Longest period abstain-last 6 months (alcohol)}
#'     \item{\code{T1}}{Have used alcohol since leaving River St. (0=No, 1=Yes)}
#'     \item{\code{T2B}}{# days in row continued to use heroin}
#'     \item{\code{T2C}}{Longest period abstain-last 6 months (heroin)}
#'     \item{\code{T2}}{Have used heroin since leaving River St (0=No, 1=Yes)}
#'     \item{\code{T3B}}{# days in row continued to use cocaine}
#'     \item{\code{T3C}}{Longest period abstain-last 6 months (cocaine)}
...
#'     \item{\code{U10A}}{# times been to regular MDs office-pst 6 months}
#'     \item{\code{U10B}}{# times saw regular MD in office-pst 6 months}
#'     \item{\code{U10C}}{# times saw oth prof in office-pst 6 months}
#'     \item{\code{U11}}{Rate convenience of MD office location (1=Very poor, 2=Poor, 3=Fair, 4=Good, 5=Very good, 6=Excellent)}
#'     \item{\code{U12}}{Rate hours MD office open for medical appointments (1=Very poor, 2=Poor, 3=Fair, 4=Good, 5=Very good, 6=Excellent)}
#'     \item{\code{U13}}{Usual wait for appointment when sick (unscheduled) (1=Very poor, 2=Poor, 3=Fair, 4=Good, 5=Very good, 6=Excellent)}
#'     \item{\code{U14}}{Time wait for appointment to start at MD office (1=Very poor, 2=Poor, 3=Fair, 4=Good, 5=Very good, 6=Excellent)}
...
#'     \item{\code{U21A}}{How thorough MD exam to check health prb (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
...
#'     \item{\code{U22C}}{MD explanations of health problems/treatments need (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U22D}}{MD instructions re symptom report/further care (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U22E}}{MD advice in decisions about your care (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U23}}{How often leave MD office with unanswd quests (1=Always, 2=Almost always, 3=A lot of the time, 4=Some of the time, 5=Almost never, 6=Never)}
#'     \item{\code{U24A}}{Amount of time your MD spends with you (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
...
#'     \item{\code{U25B}}{Reg MD ever talked to you about alcohol use (0=No, 1=Yes)}
...
#'     \item{\code{U2G}}{Afraid others discover health prb I have (0=No, 1=Yes)}
...
#'     \item{\code{U32C}}{Coordination between them and your regular MD (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U32D_T}}{N/A, only my regular MD does this}
#'     \item{\code{U32D}}{Their explanation of your health prbs/trtmts need (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
...
#'     \item{\code{U34}}{Has MD ever recommended you see MD specialists (0=No, 1=Yes)}
#'     \item{\code{U35A}}{How helpful MD in deciding on specialist (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U35B}}{How helpful MD getting appointment with specialist (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U35C}}{MDs involvement when you trtd by specialist (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
#'     \item{\code{U35D}}{MDs communication w/your specialists/oth MDs (1=Very poor, 2= Poor, 3=Fair, 4=Good, 5= Very good, 6= Excellent)}
...
#'     \item{\code{U38}}{How many minutes late appointment usually begin (1=None, 2=<5 minutes, 3=6-10 minutes, 4=11-20 minutes, 5=21-30 minutes, 6=31-45 minutes, 7=>45 minutes)}
...
#'     \item{\code{U3B}}{Has MD evr talked to you about alcohol use (0=No, 1=Yes)}
#'     \item{\code{U4}}{Is there an MD you consider your regular MD (0=No, 1=Yes)}
#'     \item{\code{U5}}{Have you seen any MDs in last 6 months (0=No, 1=Yes)}
#'     \item{\code{U6A}}{Would you go to this MD if med prb not emergency (0=No, 1=Yes)}
#'     \item{\code{U6B}}{Think one of these could be your regular MD (0=No, 1=Yes)}
#'     \item{\code{U7A_T}}{a factor with levels \code{} \code{ARTHRITIS DOCTOR} \code{CHIROPRACTOR} \code{COCAINE STUDY} \code{DETOX DOCTOR} \code{DO} \code{EAR DOCTOR} \code{EAR SPECIALIST} \code{EAR, NOSE, & THROAT.} \code{EAR/NOSE/THROAT} \code{ENT} \code{FAMILY PHYSICIAN} \code{GENERAL MEDICINE} \code{GENERAL PRACTICE} \code{GENERAL PRACTITIONER} \code{GENERAL PRACTITIONER} \code{HEAD & NECK SPECIALIST} \code{HERBAL/HOMEOPATHIC/ACUPUNCTURE} \code{ID DOCTOR} \code{MAYBE GENERAL PRACTITIONER} \code{MEDICAL STUDENT} \code{NEUROLOGIST} \code{NURSE} \code{NURSE PRACTITIONER} \code{NURSE PRACTITIONER} \code{ONCOLOGIST} \code{PRENATAL} \code{PRIMARY} \code{PRIMARY CARE} \code{PRIMARY CARE} \code{PRIMARY CARE DOCTOR} \code{PRIMARY CARE} \code{THERAPIST} \code{UROLOGIST} \code{WOMENS CLINIC BMC}}
...
#'     \item{\code{U8B}}{Saw this person for < 6 months (1 = <6 months)}
#'     \item{\code{U8C}}{Saw this person for 6 months - 1 year (2=Between 6 months & 1 year)}
...
#'     \item{\code{UNEMPLOY}}{Usually unemployed last 6 months (0=No, 1=Yes)}
#'     \item{\code{V1}}{Ever needed to drink much more to get effect (0=No, 1=Yes)}
#'     \item{\code{V2}}{Evr find alcohol had < effect than once did (0=No, 1=Yes)}
